...
class ReportsView(QWidget):
    ...
    def load_reports(self):
        try:
            ...
            conn = self.report_controller.sale_repo.db.get_connection()
            cursor = conn.cursor()
            ...
            # ===== KARTA MA'LUMOTLARINI HISOBI =====
            naxt_total = payment_stats['naxt_total'] + payment_stats['mixed_cash']
            plastik_total = payment_stats['plastik_total'] + payment_stats['mixed_card']
            mixed_total = payment_stats['mixed_total']
            ...
            for sale in sales_data:
                ...
                for item in items:
                    data.append({
                        ...
                        'Mashina': sale['car_number'] or '-',
                        'Mahsulot': item['product_name'],
                        'Miqdor': item['quantity'],
                        'Narx': item['sell_price'],
                        'Jami': item['subtotal'],
                        'Foyda': item['subtotal'] - (item['cost_price'] * item['quantity']),
    ...
    def export_to_pdf(self):
        try:
            ...
            payment_summary = cursor.execute('''
                SELECT 
                    payment_type,
                    COUNT(*) as count,
