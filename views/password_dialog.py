...
class ChangePasswordDialog(QDialog):
    ...
    def change_password(self):
        try:
            ...
            if not self.check_admin_password(old):
                self.error_label.setText("❌ Eski parol noto'g'ri!")
                return
            
            if self.update_admin_password(new):
                ...
                self.error_label.setText("❌ Parolni o'zgartirishda xatolik yuz berdi!")
